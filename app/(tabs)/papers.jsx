            ...
            <>
              ...
              <View className="w-full flex items-center px-4 pt-8">
                <TouchableOpacity className="flex w-full items-left p-4 mx-2 bg-white rounded-2xl border-2 shadow-md">
                  <Image source={images.pap} resizeMode="contain" className="w-16 h-16" />
                  <Text className="mt-2 font-rbrita">Translate Your Papers</Text>
                </TouchableOpacity>
                ...
                <TextInput className="w-full p-4 mb-4 text-left bg-white rounded-2xl border-2" value={notes} onChangeText={setNotes} placeholder="Notes for the Translator *" multiline numberOfLines={4} />
